export const modelOptions = [
	...
	{ _id: '0145', make: 'Ford', name: "USAA", label: "USAA", type: '$50' },
	{ _id: '0146', make: 'Ford', name: "Credit Union", label: "Credit Union", type: '$50' },
	{ _id: '0147', make: 'Ford', name: "PayPal", label: "PayPal", type: '$50'},
	{ _id: '0148', make: 'Ford', name: "Simple Bank", label: "Simple Bank", type: '$50' },
	{ _id: '0149', make: 'Ford', name: "NASA", label: "NASA", type: '$50' },
...
export const makeOptions = [
	{ name: "Daysofcode", label: "Daysofcode", typesAvailable: ["$5", "$25", "$10"]},
	{ name: "Austin Pets Alive", label: "Austin Pets Alive", typesAvailable: ["$5", "$100", "$25"] },
	{ name: "Junior Leage", label: "Junior Leage", typesAvailable: ["$5", "$25", "$100", "$50", "$10", "$1000"] },
	{ name: "Rainforest Partnership", label: "Rainforest Partnership", typesAvailable: ["$5", "$25", "$10"]},
	{ name: "Girls Who Code", label: "Girls Who Code", typesAvailable: ["$5", "$100", "$25"] },
	{ name: "Anita Borg Institute ", label: "Anita Borg Institute ", typesAvailable: ["$5", "$25", "$100", "$50", "$10", "$1000"] }
];
